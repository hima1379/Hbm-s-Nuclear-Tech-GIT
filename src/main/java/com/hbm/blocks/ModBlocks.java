...
public class ModBlocks {
	...
	public static final Block blue_cable = new com.hbm.blocks.network.data.BlockCableBlue(Material.IRON, "blue_cable").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block fcs_console = new com.hbm.blocks.network.data.BlockFCSConsole(Material.IRON, "fcs_console").setHardness(5.0F).setResistance(10.0F);
	public static final Block spy1_radar = new com.hbm.blocks.network.data.BlockSPY1(Material.IRON, "spy1_radar");
	public static final Block spy6_radar = new com.hbm.blocks.network.data.BlockSPY6(Material.IRON, "spy6_radar");
	public static final Block spg62_radar = new com.hbm.blocks.network.data.BlockSPG62(Material.IRON, "spg62_radar");
	...
	public static final Block turret_howard = new TurretHoward(Material.IRON, "turret_howard").setHardness(20.0F).setResistance(8000.0F).setCreativeTab(MainRegistry.weaponTab);
	public static final Block turret_howard_damaged = new TurretHowardDamaged(Material.IRON, "turret_howard_damaged").setHardness(20.0F).setResistance(8000.0F).setCreativeTab(MainRegistry.weaponTab);
	...
	public static final int guiID_fcs_console = 135;
	public static final int guiID_spy1_radar = 136;
	public static final int guiID_spy6_radar = 137;
	...
	// New Fusion Reactor System
	public static final Block machine_fusion_collector = new com.hbm.blocks.machine.fusion.MachineFusionCollector("machine_fusion_collector").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_klystron = new com.hbm.blocks.machine.fusion.MachineFusionKlystron("machine_fusion_klystron").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_klystron_creative = new com.hbm.blocks.machine.fusion.MachineFusionKlystronCreative("machine_fusion_klystron_creative").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_torus = new com.hbm.blocks.machine.fusion.MachineFusionTorus("machine_fusion_torus").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_coupler = new com.hbm.blocks.machine.fusion.MachineFusionCoupler("machine_fusion_coupler").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_boiler = new com.hbm.blocks.machine.fusion.MachineFusionBoiler("machine_fusion_boiler").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_mhdt = new com.hbm.blocks.machine.fusion.MachineFusionMHDT("machine_fusion_mhdt").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final Block machine_fusion_breeder = new com.hbm.blocks.machine.fusion.MachineFusionBreeder("machine_fusion_breeder").setHardness(5.0F).setResistance(60.0F).setCreativeTab(MainRegistry.machineTab);
	public static final int guiID_fusion_klystron = 266;
	public static final int guiID_fusion_torus = 267;
	public static final int guiID_fusion_breeder = 268;
