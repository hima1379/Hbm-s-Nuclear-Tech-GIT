package com.hbm.main.tileentity.machine.rbmk;
...
import com.hbm.handler.RBMKMeltdownContaminationHandler;
...
public abstract class TileEntityRBMKBase extends TileEntity implements INBTPacketReceiver, ITickable, IControllable {
	...
	public void meltdown() {
		...
		// Register Gaussian plume atmospheric contamination sources.
		// Must be called BEFORE onMelt() which clears fuel rod inventories.
		RBMKMeltdownContaminationHandler.onMeltdown(world, columns, minX, maxX, minZ, maxZ);
