...
public class RenderFusionCollector extends TileEntitySpecialRenderer<TileEntityFusionCollector> {
	...
	@Override
	public boolean isGlobalRenderer(TileEntityFusionCollector te) {
		return true;
	}

	@Override
	public void render(TileEntityFusionCollector te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
