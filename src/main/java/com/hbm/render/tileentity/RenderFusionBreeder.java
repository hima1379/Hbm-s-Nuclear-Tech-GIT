...
public class RenderFusionBreeder extends TileEntitySpecialRenderer<TileEntityFusionBreeder> {
	...
	@Override
	public boolean isGlobalRenderer(TileEntityFusionBreeder te) {
		return true;
	}

	@Override
	public void render(TileEntityFusionBreeder te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
