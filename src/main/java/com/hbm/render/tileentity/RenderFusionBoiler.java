...
public class RenderFusionBoiler extends TileEntitySpecialRenderer<TileEntityFusionBoiler> {
	...
	@Override
	public boolean isGlobalRenderer(TileEntityFusionBoiler te) {
		return true;
	}

	@Override
	public void render(TileEntityFusionBoiler te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		GL11.glPushMatrix();
